                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            ...
                            <form class="row login_form" action="UserRegisterServlet" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="password" class="form-control" id="name" name="re_password" placeholder="Re password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Repassword'" required>
                                </div>
                                <div class="col-md-12 form-group">
