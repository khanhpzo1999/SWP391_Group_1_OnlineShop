                ...
                <div class="col">
                    ...
                    <div>
                        <p style="font-size: 15px; color: red; text-align: center;">
                            <i>Do you want to delete this product? If
                                the product is
                                deleted, this action cannot be undone and
                                may
                                affect the orders being traded on the system.</i>
                        </p>
                    </div>
                    <!-- Form field -->
                    <div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" id="form6Example1" class="form-control" value="${p.product_name}" disabled />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example2">Self price</label>
                                        <input type="text" id="form6Example2" class="form-control" value="${p.product_price}" disabled />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col">
                                    ...
                                    <input type="text" id="form6Example4" class="form-control" value="${p.product_quatity}" disabled />
                                </div>
                                <div class="col">
                                    <label class="form-label" for="form6Example2">Description</label>
                                    <input type="text" id="form6Example3" class="form-control" value="${p.product_description}" disabled />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <a type="submit" class="btn btn-primary"
                                       href="productManagement">Cancel</a>
                                </div>
                                <div class="col">
                                    <button type="submit" class="btn btn-danger mb-4">Delete product</button>
                                </div>
                            </div>
                        </form>
                    </div>
