                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-outline">
                                    ...
                                    <input type="text" id="form6Example2" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <input type="text" id="form6Example3" class="form-control" disabled />
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <a type="submit" class="btn btn-primary"
                                    href="${pageContext.request.contextPath}/productManagement">Cancel</a>
                            </div>
                            <div class="col">
                                <a type="submit" class="btn btn-danger"
                                    href="${pageContext.request.contextPath}/productManagement">Delete product</a>
                            </div>
                        </div>
                    </form>
                </div>
