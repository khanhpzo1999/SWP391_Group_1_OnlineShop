                            ...
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="category?id=${requestScope.id}">Category</a></li>

                                        <li class="nav-item"><a class="nav-link" href="list">Product</a></li>
                                        <li class="nav-item"><a class="nav-link" href="viewlistcomingproduct">Product Coming</a></li>
                                ...
                                <li class="nav-item submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="login.html">List Order</a></li>
                                        <!--                                        <li class="nav-item"><a class="nav-link" href="tracking.html">Order Confi</a></li>
