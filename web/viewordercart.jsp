                                    ...
                                    <td>
                                        <form method="POST" action="./checkout">
                                            <div class="col-md-12 form-group">
                                                full name <input name="name" type="text" required="" class="form-control" id="name"  name="name" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                                            </div>
                                            <div class="col-md-12 form-group">
